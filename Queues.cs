//реализация очереди и двусторонней очереди
...
/*
 abstract class ParentQueue<T>
   ...
   public int get_status_peekFront();     //не вызывался; успех; неудача - очередь пуста
   public int get_status_removeFront(); //не вызывался; успех; неудача - очередь пуста
...
/*
 abstract class Deque<T> : ParentQueue<T>
   ...
   public int get_status_peekTail();   //не вызывался; успех; неудача - очередь пуста
   public int get_status_removeTail(); //не вызывался; успех; неудача - очередь пуста
 */
...
namespace lab6
{
    ...
    class ParentQueue<T>
    {
        ...
        public int get_status_peekFront() { return status_peekFront; }   //не вызывался; успех; неудача - очередь пуста
        public int get_status_removeFront() { return status_removeFront; } //не вызывался; успех; неудача - очередь пуста
    }
    ...
    class Deque<T> : ParentQueue<T>
    {
        ...
        public int get_status_peekTail() { return status_peekTail; }     //не вызывался; успех; неудача - очередь пуста
        public int get_status_removeTail() { return status_removeTail; } //не вызывался; успех; неудача - очередь пуста
    }
